...
* FIXES
  ...
  - [fr3akX/artisan issue #6](https://github.com/fr3akX/artisan/issues/6): Santoker warm-up `ON`/target is restored after automatic reconnect, and a read-only protocol diagnostics window captures current-session events. Official-app reconnect behavior was established by static analysis; physical X3 verification is pending.
